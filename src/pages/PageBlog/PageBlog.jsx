            ...
            <section>
                <div className="p-4 max-w-screen-xl  mx-auto  ">
                    ...
                    >
                        ...
                        {/* Render unique categories from data */}
                    ...
                    <Link key={pageblogs.id} to={pageblogs.path} className="text-white hover:opacity-80 duration-300">
                        <div className="card shadow-xl overflow-hidden inline-block">
                            ...
                            <div className="bg-blue-900/25 p-5 rounded-b-xl">
                                ...
                                <p className="text-slate-300/70">{pageblogs.content}</p>
