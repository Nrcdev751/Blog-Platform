                ...
                <div className="p-4 max-w-screen-xl mx-auto">
                    ...
                    <div className="md:grid grid-cols-6">
                        ...
                        <label className="input input-bordered mb-3 flex items-center gap-2">
                            ...
                            <div className="blog-1 flex py-2">
                                <img className=" w-1/3 rounded-2xl" src="https://images.unsplash.com/photo-1707343844152-6d33a0bb32c3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                                <div className="ms-3">
