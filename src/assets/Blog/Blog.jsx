            ...
            <section className="p-3">
                <div className="p-4 max-w-screen-xl mx-auto">
                    <div className="flex justify-between items-center">
                                ...
                                <p className="text-2xl py-3 text-white">บทความของเรา</p>
                                ...
                                <div className="blog relative">
                                    <div className="flex">
                                        ...
                                        <div className="absolute bottom-0 p-3 ">
                                            <p className="text-white md:text-md lg:text-2xl">Lorem ipsum dolor sit amet.</p>
                                            <p className="text-white md:hidden xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente, ratione?</p>
                                        </div>
